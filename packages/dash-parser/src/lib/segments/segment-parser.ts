import type { Segment } from '../types/parsed-manifest';
 ...
 * @returns The result of parsing the end number.
 */
...
export const segmentRanges: SegmentRanges = {
   ...
   * @returns The start and end numbers for available segments
   */
 ...
 * @returns List of Objects with segment timing and duration info
 */
